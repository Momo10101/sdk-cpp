...
#define DEFINE_RECEIPT_TYPE(BASIC_TYPE, FACILITY, DESCRIPTION, CODE) \
	...
	namespace {
		const char* ToString(ReceiptType receiptType) {
			...
			#include "symbol_sdk/plugins/txes/lock_hash/src/model/HashLockReceiptType.h"
			#include "symbol_sdk/plugins/txes/lock_secret/src/model/SecretLockReceiptType.h"
			#include "symbol_sdk/plugins/txes/mosaic/src/model/MosaicReceiptType.h"
			#include "symbol_sdk/plugins/txes/namespace/src/model/NamespaceReceiptType.h"
			}
